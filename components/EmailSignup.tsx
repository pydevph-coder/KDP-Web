...
export default function EmailSignup() {
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-primary-1/10 to-primary-2/10">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
          <input
            ...
            required
            className="flex-1 px-6 py-3 rounded-full border-2 border-primary-1 focus:outline-none focus:border-primary-2 text-text-primary"
          />
          <button
            type="submit"
