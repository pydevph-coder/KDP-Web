    ...
    <section className="relative flex items-center justify-center bg-gradient-to-br from-background-1 via-background-2 to-background-1 px-4 sm:px-6 py-12 sm:py-20">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className="text-center md:text-left space-y-4 sm:space-y-6 order-1 md:order-2">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-text-primary leading-tight">
            Transform Your Spiritual Journey
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-text-primary/80 leading-relaxed px-2 sm:px-0">
      ...
      <div className="hidden md:block absolute top-20 right-10 w-32 h-32 bg-primary-1/20 rounded-full blur-3xl -z-10"></div>
      <div className="hidden md:block absolute bottom-20 left-10 w-40 h-40 bg-primary-2/20 rounded-full blur-3xl -z-10"></div>
    </section>
  );
}
